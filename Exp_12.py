...
# plt.title('Discrete-Time + Discrete-Amplitude Signal')
# plt.xlabel('Time [s]')
# plt.ylabel('Amplitude')
...
# # Combined signal
# plt.subplot(3, 1, 3)
# plt.plot(t, combined, color='green')
...
# # Time shift (0.1 seconds)
# shift = 0.1
# shifted = np.sin(2 * np.pi * f * (t - shift))
# # Plot both signals
# plt.figure(figsize=(10, 5))
# plt.plot(t, original, label='Original Signal (5 Hz)')
# plt.plot(t, shifted, label='Shifted Signal (5 Hz, delay = 0.1s)', linestyle='--')
...
# t = np.linspace(0, 1, fs, endpoint=False)  # Time vector (1 second)
# f = 10                      # Frequency (Hz)
# # Original 10 Hz sine wave
# original = np.sin(2 * np.pi * f * t)
# # Scaled signal (amplitude ×3)
# scaled = 3 * original
# # Plot both signals
# plt.figure(figsize=(10, 5))
# plt.plot(t, original, label='Original Signal (10 Hz)')
# plt.plot(t, scaled, label='Scaled Signal (×3 Amplitude)', linestyle='--')
...
t = np.linspace(0, 1, fs, endpoint=False)  # Time vector (1 second)
f = 5                       # Frequency (Hz)
# Original 5 Hz sine wave
original = np.sin(2 * np.pi * f * t)
# Time-reversed signal (x[-t])
reversed_signal = np.sin(2 * np.pi * f * (-t))
# Plot both signals
plt.figure(figsize=(10, 5))
plt.plot(t, original, label='Original Signal (5 Hz)')
